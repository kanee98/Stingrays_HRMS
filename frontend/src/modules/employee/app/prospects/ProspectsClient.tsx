          ...
          <SectionCard eyebrow="Create" title="Add prospect manually" description="Capture a candidate directly without waiting for an Excel upload and keep the record in the same onboarding pipeline.">
            {typesLoading ? (
              ...
              <div className="space-y-4">
                ...
                <Link href={employeePath('/settings/prospect-types')} className={secondaryButtonClasses}>Open prospect type settings</Link>
              </div>
            ) : (
        ...
        <SectionCard eyebrow="Import" title="Excel import" description="Upload a prospect spreadsheet and tag the imported candidates with the correct prospect type.">
          {typesLoading ? (
            ...
            <div className="space-y-4">
              ...
              <Link href={employeePath('/settings/prospect-types')} className={secondaryButtonClasses}>Configure prospect types</Link>
            </div>
          ) : (
                    ...
                    <tr key={prospect.Id} className={tableBodyRowClasses}>
                      ...
                      <td className="py-4 text-right">
                        <div className="flex justify-end gap-4">
                          <Link href={employeePath(`/prospects/checklist/${prospect.Id}`)} className={inlineActionClasses}>Checklist</Link>
                          {prospect.ConvertedToEmployeeId ? <Link href={employeePath(`/onboarding?employeeId=${prospect.ConvertedToEmployeeId}`)} className={inlineActionClasses}>Onboarding</Link> : null}
